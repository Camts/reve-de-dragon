...
class Carac {
	...
	set val(val) {
		...
		if (this.nom == "taille" || this.nom == "agilite") {
			this[pPerso].carac.derobee = Math.max(Math.floor((21 - this[pPerso].carac.taille.val + this[pPerso].carac.agilite.val) / 2), 0);
			let i;
			for (i in this[pPerso].eqmt.arme) {
				let arme = this[pPerso].eqmt.arme[i];
		...
		if (this.nom == "taille" || this.nom == "force") {
			this[pPerso].carac.bonusDommages = this[pPerso].carac.taille.val < 6 ? 0 : Carac.bonusDommages[this[pPerso].carac.taille.val - 6][this[pPerso].carac.force.val - 6];
			let i;
			for (i in this[pPerso].eqmt.arme) {
				let arme = this[pPerso].eqmt.arme[i];
...
Carac.bonusDommages /* [taille - 6][force - 6] */ = [
	...
	/* 18 */[0, 1, 1, 1, 2, 2, 2, 3, 4, 5, 6, 7, 7,  8,  8,  9,  9, 10, 10, 11, 11, 12],
	/* 19 */[1, 1, 1, 1, 2, 2, 2, 3, 4, 5, 6, 7, 7,  8,  8,  9,  9, 10, 10, 11, 11, 12, 12],
	/* 20 */[1, 1, 1, 1, 2, 2, 2, 3, 4, 5, 6, 7, 7,  8,  8,  9,  9, 10, 10, 11, 11, 12, 12, 12, 13],
	/* 21 */[1, 1, 2, 2, 2, 3, 3, 4, 5, 6, 7, 7, 8,  8,  9,  9, 10, 10, 11, 11, 12, 12, 12, 13, 13],
	/* 22 */[1, 1, 2, 2, 2, 3, 3, 4, 5, 6, 7, 7, 8,  8,  9,  9, 10, 10, 11, 11, 12, 12, 12, 13, 13],
	/* 23 */[1, 1, 2, 2, 2, 3, 3, 4, 5, 6, 7, 7, 8,  8,  9,  9, 10, 10, 11, 11, 12, 12, 12, 13, 13],
	/* 24 */[1, 2, 2, 2, 3, 3, 4, 5, 6, 7, 7, 8, 8,  9,  9, 10, 10, 11, 11, 12, 12, 12, 13, 13, 13],
	/* 25 */[1, 2, 2, 2, 3, 3, 4, 5, 6, 7, 7, 8, 8,  9,  9, 10, 10, 11, 11, 12, 12, 12, 13, 13, 13],
	/* 26 */[1, 2, 2, 2, 3, 3, 4, 5, 6, 7, 7, 8, 8,  9,  9, 10, 10, 11, 11, 12, 12, 12, 13, 13, 13],
	/* 27 */[2, 2, 2, 3, 3, 4, 5, 6, 7, 7, 8, 8, 9,  9, 10, 10, 11, 11, 12, 12, 12, 13, 13, 13, 14],
	/* 28 */[2, 2, 2, 3, 3, 4, 5, 6, 7, 7, 8, 8, 9,  9, 10, 10, 11, 11, 12, 12, 12, 13, 13, 13, 14],
	/* 29 */[2, 2, 2, 3, 3, 4, 5, 6, 7, 7, 8, 8, 9,  9, 10, 10, 11, 11, 12, 12, 12, 13, 13, 13, 14],
	/* 30 */[2, 2, 3, 3, 4, 5, 6, 7, 7, 8, 8, 9, 9, 10, 10, 11, 11, 12, 12, 12, 13, 13, 13, 14, 14]];
